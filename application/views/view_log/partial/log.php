<div class="table-responsive">
	<table class="table table-sm table-striped table-hover">
		...
		<?php  $i = 0;  foreach ($results->result() as $row) { ?>
			...
			<?php } ?>
			<td><a data-fancybox data-type="iframe" data-width="750" data-height="520" data-src="<?php echo site_url('logbook/view')."/".$row->COL_PRIMARY_KEY; ?>" href="javascript:;"><?php echo strtoupper($row->COL_CALL); ?></a>
			</td>
