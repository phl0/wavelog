<div class="container">
	...
	<tr>
		...
		<td style="text-align: center"><a href="javascript:displayDistanceQsos('<?php echo $row->sat; ?>')"><?php echo ($row->sat_description != null ? $row->sat_description." (".$row->sat.")" : $row->sat); ?></a></td>
